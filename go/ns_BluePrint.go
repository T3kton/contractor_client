/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/BluePrint/ at 2020-05-02T23:55:10.746165
 */
package contractor
...
func (service *Contractor) BlueprintBluePrintList(filterName string, filterValues map[string]interface{}) <-chan *BlueprintBluePrint {
	...
	go func() {
		defer close(out)
		for v := range in {
			v.(*BlueprintBluePrint).cinp = service.cinp
