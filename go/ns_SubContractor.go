/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/SubContractor/ at 2020-05-02T23:55:10.746165
 */
package contractor
...
func (service *Contractor) SubcontractorDispatchList(filterName string, filterValues map[string]interface{}) <-chan *SubcontractorDispatch {
	...
	go func() {
		defer close(out)
		for v := range in {
			v.(*SubcontractorDispatch).cinp = service.cinp
...
func (service *Contractor) SubcontractorDHCPdList(filterName string, filterValues map[string]interface{}) <-chan *SubcontractorDHCPd {
	...
	go func() {
		defer close(out)
		for v := range in {
			v.(*SubcontractorDHCPd).cinp = service.cinp
