/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Proxmox/ at 2020-05-08T12:31:05.921360
 */
package contractor
...
func (object *ProxmoxProxmoxComplex) AsMap(isCreate bool) *map[string]interface{} {
	if isCreate {
		return &map[string]interface{}{ 
			...
			"proxmox_host": object.ProxmoxHost,
...
func (object *ProxmoxProxmoxFoundation) AsMap(isCreate bool) *map[string]interface{} {
	if isCreate {
		return &map[string]interface{}{ 
			...
			"proxmox_vmid": object.ProxmoxVmid,
		}
	}
	return &map[string]interface{}{ 
		"site": object.Site,
