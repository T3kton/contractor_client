/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Building/ at 2021-09-28T20:47:20.561620
 */
package contractor
...
// BuildingStructureCallGetWithHostnameSite calls getWithHostnameSiteNoneNone
...
// CallCreateFoundation calls createFoundationNoneNoneNone
func (object *BuildingComplex) CallCreateFoundation(hostname string, site string, interface_map_list []map[string]interface{}) (string, error) {
	args := map[string]interface{}{
		"hostname": hostname,
		"site": site,
		"interface_map_list": interface_map_list,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
		return "", err
