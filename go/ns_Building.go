/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Building/ at 2020-08-13T22:23:45.513882
 */
package contractor
...
func (object *BuildingComplex) CallCreateFoundation(hostname string, site string, interface_name_list []string) (string, error) {
	args := map[string]interface{}{
		"hostname": hostname,
		"site": site,
