// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/VCenter/ at 2022-01-08T19:31:37.129298
package contractor
...
func (service *Contractor) VcenterVCenterComplexList(filterName string, filterValues map[string]interface{}) (<-chan *VcenterVCenterComplex, error) {
	if filterName != "" {
...
func (service *Contractor) VcenterVCenterFoundationList(filterName string, filterValues map[string]interface{}) (<-chan *VcenterVCenterFoundation, error) {
	if filterName != "" {
