/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Foreman/ at 2020-05-02T23:55:10.746165
 */
package contractor
...
func (service *Contractor) ForemanBaseJobList(filterName string, filterValues map[string]interface{}) <-chan *ForemanBaseJob {
	...
	go func() {
		defer close(out)
		for v := range in {
			v.(*ForemanBaseJob).cinp = service.cinp
...
func (object *ForemanBaseJob) CallClearDispatched() (string, error) {
	args := map[string]interface{}{
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
