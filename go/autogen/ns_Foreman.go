// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Foreman/ at 2024-03-24T03:21:24.739985
package contractor
...
func (service *Contractor) ForemanBaseJobNewWithID(id int) *ForemanBaseJob {
	...
	result.SetID("/api/v1/Foreman/BaseJob:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}
...
func (object *ForemanBaseJob) CallSignalComplete(Cookie string) (string, error) {
	args := map[string]interface{}{
		"cookie": Cookie,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
...
func (object *ForemanBaseJob) CallSignalAlert(Msg string) (string, error) {
	args := map[string]interface{}{
		"msg": Msg,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
...
func (object *ForemanBaseJob) CallPostMessage(Msg string) (string, error) {
	args := map[string]interface{}{
		"msg": Msg,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
...
func (service *Contractor) ForemanFoundationJobNewWithID(id int) *ForemanFoundationJob {
	...
	result.SetID("/api/v1/Foreman/FoundationJob:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}

// ForemanFoundationJobGet - Get function for Model FoundationJob
func (service *Contractor) ForemanFoundationJobGet(id int) (*ForemanFoundationJob, error) {
	object, err := service.cinp.Get("/api/v1/Foreman/FoundationJob:" + strconv.FormatInt(int64(id), 10) + ":")
	if err != nil {
		return nil, err
	}
...
func (service *Contractor) ForemanFoundationJobList(filterName string, filterValues map[string]interface{}) (<-chan *ForemanFoundationJob, error) {
	if filterName != "" {
...
func (service *Contractor) ForemanStructureJobNewWithID(id int) *ForemanStructureJob {
	...
	result.SetID("/api/v1/Foreman/StructureJob:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}

// ForemanStructureJobGet - Get function for Model StructureJob
func (service *Contractor) ForemanStructureJobGet(id int) (*ForemanStructureJob, error) {
	object, err := service.cinp.Get("/api/v1/Foreman/StructureJob:" + strconv.FormatInt(int64(id), 10) + ":")
	if err != nil {
		return nil, err
	}
...
func (service *Contractor) ForemanStructureJobList(filterName string, filterValues map[string]interface{}) (<-chan *ForemanStructureJob, error) {
	if filterName != "" {
...
func (service *Contractor) ForemanDependencyJobNewWithID(id int) *ForemanDependencyJob {
	...
	result.SetID("/api/v1/Foreman/DependencyJob:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}

// ForemanDependencyJobGet - Get function for Model DependencyJob
func (service *Contractor) ForemanDependencyJobGet(id int) (*ForemanDependencyJob, error) {
	object, err := service.cinp.Get("/api/v1/Foreman/DependencyJob:" + strconv.FormatInt(int64(id), 10) + ":")
	if err != nil {
		return nil, err
	}
...
func (service *Contractor) ForemanDependencyJobList(filterName string, filterValues map[string]interface{}) (<-chan *ForemanDependencyJob, error) {
	if filterName != "" {
...
func (service *Contractor) ForemanJobLogNewWithID(id int) *ForemanJobLog {
	...
	result.SetID("/api/v1/Foreman/JobLog:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}

// ForemanJobLogGet - Get function for Model JobLog
func (service *Contractor) ForemanJobLogGet(id int) (*ForemanJobLog, error) {
	object, err := service.cinp.Get("/api/v1/Foreman/JobLog:" + strconv.FormatInt(int64(id), 10) + ":")
	if err != nil {
		return nil, err
	}
...
func (service *Contractor) ForemanJobLogList(filterName string, filterValues map[string]interface{}) (<-chan *ForemanJobLog, error) {
	if filterName != "" {
