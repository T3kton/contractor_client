// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/BluePrint/ at 2024-03-26T14:17:37.955685
package contractor
...
type BlueprintFoundationBluePrint struct {
	...
	ValidationTemplate     *map[string]interface{} `json:"validation_template"`
...
func (object *BlueprintFoundationBluePrint) AsMap(isCreate bool) *map[string]interface{} {
	if isCreate {
		return &map[string]interface{}{
			...
			"validation_template":      object.ValidationTemplate,
...
func (service *Contractor) BlueprintFoundationBluePrintList(filterName string, filterValues map[string]interface{}) (<-chan *BlueprintFoundationBluePrint, error) {
	if filterName != "" {
...
func (service *Contractor) BlueprintStructureBluePrintList(filterName string, filterValues map[string]interface{}) (<-chan *BlueprintStructureBluePrint, error) {
	if filterName != "" {
...
func (service *Contractor) BlueprintScriptList(filterName string, filterValues map[string]interface{}) (<-chan *BlueprintScript, error) {
	if filterName != "" {
...
func (service *Contractor) BlueprintBluePrintScriptNewWithID(id int) *BlueprintBluePrintScript {
	...
	result.SetID("/api/v1/BluePrint/BluePrintScript:" + strconv.FormatInt(int64(id), 10) + ":")
	return &result
}

// BlueprintBluePrintScriptGet - Get function for Model BluePrintScript
func (service *Contractor) BlueprintBluePrintScriptGet(id int) (*BlueprintBluePrintScript, error) {
	object, err := service.cinp.Get("/api/v1/BluePrint/BluePrintScript:" + strconv.FormatInt(int64(id), 10) + ":")
	if err != nil {
		return nil, err
	}
...
func (service *Contractor) BlueprintBluePrintScriptList(filterName string, filterValues map[string]interface{}) (<-chan *BlueprintBluePrintScript, error) {
	if filterName != "" {
...
func (service *Contractor) BlueprintPXEList(filterName string, filterValues map[string]interface{}) (<-chan *BlueprintPXE, error) {
	if filterName != "" {
