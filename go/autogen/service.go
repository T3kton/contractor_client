// Package contractor - Automatically generated by cinp-codegen from http://127.0.0.1:8888/api/v1/ at 2024-04-04T13:21:09.245892
package contractor
...
func NewContractor(ctx context.Context, log *slog.Logger, host string, proxy string) (*Contractor, error) {
	var err error
	s := Contractor{}
