// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/VirtualBox/ at 2024-03-24T03:21:24.739985
 /*
...
func (service *Contractor) VirtualboxVirtualBoxComplexList(filterName string, filterValues map[string]interface{}) (<-chan *VirtualboxVirtualBoxComplex, error) {
	if filterName != "" {
...
func (service *Contractor) VirtualboxVirtualBoxFoundationList(filterName string, filterValues map[string]interface{}) (<-chan *VirtualboxVirtualBoxFoundation, error) {
	if filterName != "" {
