// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Survey/ at 2022-01-08T19:31:37.129298
package contractor
...
func (service *Contractor) SurveyPlotList(filterName string, filterValues map[string]interface{}) (<-chan *SurveyPlot, error) {
	if filterName != "" {
...
type SurveyCartographer struct {
	...
	InfoMap map[string]interface{} `json:"info_map"`
...
func (object *SurveyCartographer) AsMap(isCreate bool) *map[string]interface{} {
	if isCreate {
		return &map[string]interface{}{ 
			...
			"info_map": object.InfoMap,
			"last_checkin": object.LastCheckin,
		}
	}
	return &map[string]interface{}{ 
		"foundation": object.Foundation,
...
func (service *Contractor) SurveyCartographerList(filterName string, filterValues map[string]interface{}) (<-chan *SurveyCartographer, error) {
	if filterName != "" {
...
func (object *SurveyCartographer) CallAssign(Foundation string) (error) {
...
func (object *SurveyCartographer) CallLookup(InfoMap map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{
		"info_map": InfoMap,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
