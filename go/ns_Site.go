// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Site/ at 2024-03-24T00:03:41.412767
package contractor
...
func (service *Contractor) SiteSiteList(filterName string, filterValues map[string]interface{}) (<-chan *SiteSite, error) {
	if filterName != "" {
