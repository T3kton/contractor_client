/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/RedFish/ at 2021-09-01T20:51:30.009524
 */
package contractor
...
func (service *Contractor) RedfishRedFishFoundationList(filterName string, filterValues map[string]interface{}) <-chan *RedfishRedFishFoundation {
