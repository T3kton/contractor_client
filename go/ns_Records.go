/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Records/ at 2020-05-02T23:55:10.746165
 */
package contractor
...
func (service *Contractor) RecordsRecorderList(filterName string, filterValues map[string]interface{}) <-chan *RecordsRecorder {
	...
	go func() {
		defer close(out)
		for v := range in {
			v.(*RecordsRecorder).cinp = service.cinp
