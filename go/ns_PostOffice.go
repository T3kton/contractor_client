/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/PostOffice/ at 2021-09-01T20:51:30.009524
 */
package contractor
...
func (object *PostofficeFoundationBox) CallExtend(additional_hours int) (error) {
...
// CallExtend calls extendNone
func (object *PostofficeStructureBox) CallExtend(additional_hours int) (error) {
	args := map[string]interface{}{
		"additional_hours": additional_hours,
	}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
